...
<div id="team_info">
	...
	<div class="tab">
		<ul class="login">
			...
			<li class="sep">|</li>
			<li id="toggle">
				<a class="open" id="open" href="#">登录 | 注册</a>
  ...
  <div class="head">
    ...
    <div class="nav-box">
      <ul>
        ...
        <li><a class="openh" >比赛题目</a></li>
        <li><a class="openh" >提交情况</a></li>
        <li><a class="openh" >现场排名</a></li>
        <li><a class="openh" >送球</a></li>
        <li><a href="team_nosession.php"  target="_blank">参赛队</a></li>
      </ul>
