...
$sql="SELECT 
	users.user_id,users.nick,solution.result,solution.num,solution.in_date 
		FROM 
			(select * from solution where solution.contest_id='1004' and num>=0) solution 
		left join users 
...
<table width="80%" border="1" cellspacing="0" cellpadding="0">
 ...
 for($i=1,$bg = 1;$i<=58;$i++)
 {
	...
	if($info[0]=='team5' || $info[0]=='team7' || $info[0]=='team13' || $info[0]=='team14' || $info[0]=='team16' || $info[0]=='team18' || $info[0]=='team19' || $info[0]=='team21' || $info[0]=='team25' || $info[0]=='team26' || $info[0]=='team27' || $info[0]=='team28' || $info[0]=='team29' || $info[0]=='team30' || $info[0]=='team31' || $info[0]=='team32' || $info[0]=='team33' || $info[0]=='team34' || $info[0]=='team35' || $info[0]=='team36' || $info[0]=='team38' || $info[0]=='team39' || $info[0]=='team40' || $info[0]=='team41' || $info[0]=='team43' || $info[0]=='team44' || $info[0]=='team47' || $info[0]=='team56' || $info[0]=='team58' )
	continue ;
	$bg++;
	if($info[0]=='team24')
