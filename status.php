...
//				echo $_SESSION['freshman_contest'];
...
if($_SESSION['freshman_contest'] == 0 && (($row['problem_id'] >1000 && $row['problem_id'] <= 1008) || ($row['problem_id'] >1016 && $row['problem_id'] <= 1021)) )
{	
...
{
	if($_SESSION['freshman_contest'] == 1 && (($row['problem_id'] >1008 && $row['problem_id'] <= 1016) || ($row['problem_id'] >1021 && $row['problem_id'] <= 1026)))
	{
		if($i==0&&$row['result']<4) $last=$row['solution_id'];
