...
$sql="SELECT 
	users.user_id,users.nick,solution.result,solution.num,solution.in_date 
		FROM 
			(select * from solution where solution.contest_id='1016' and num>=0) solution 
		left join users 
...
if($info[0]=='team1'||$info[0]=='team2'|| $info[0]=='team6' || $info[0]=='team7' || $info[0]=='team9' || $info[0]=='team10' || $info[0]=='team11' || $info[0]=='team15' ||$info[0]=='team21'||$info[0]=='team22' || $info[0]=='team23' || $info[0]=='team26' || $info[0]=='team27' || $info[0]=='team28' || $info[0]=='team31' || $info[0]=='team32'|| $info[0]=='team40' || $info[0]=='team41' || $info[0]=='team43' || $info[0]=='team44' || $info[0]=='team47' || $info[0]=='team48' || $info[0]=='team52' || $info[0]=='team55' || $info[0]=='team57' || $info[0]=='team58' || $info[0]=='team59' || $info[0]=='team61' || $info[0]=='team62' || $info[0]=='team63' || $info[0]=='team66' || $info[0]=='team67' || $info[0]=='team80' || $info[0]=='team93' || $info[0]=='team92' || substr($info[0],4)>=42)
		{continue;}
