  ...
  <div class="head">
    ...
    <div class="nav-box">
      <ul>
        ...
        <li><a onclick="alert('请您先点击右上角登录或注册')">比赛题目</a></li>
        <li><a onclick="alert('请您先点击右上角登录或注册')">提交情况</a></li>
        <li><a onclick="alert('请您先点击右上角登录或注册')">现场排名</a></li>
        <li><a onclick="alert('请您先点击右上角登录或注册')">送球</a></li>
        <li><a onclick="alert('请您先点击右上角登录或注册')">参赛队</a></li>
      </ul>
