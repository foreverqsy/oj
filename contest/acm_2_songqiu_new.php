...
<title>SUT_ACM--送球系统(新生赛)</title>
</head>
<?php require_once("./include/db_info.inc.php"); ?>
<body>
<h1 style="text-align:center; color:#603; font-family:微软雅黑;">SUT_ACM-------送球系统<font style="font-size:20px;">(新生赛)</font></h1>
<br /><br />
  <?php
$sql="SELECT 
	users.user_id,users.nick,solution.result,solution.num,solution.in_date 
		FROM 
			(select * from solution where solution.contest_id='1013' and num>=0) solution 
		left join users 
...
<table width="80%" border="1" cellspacing="0" cellpadding="0">
 ...
 for($i=1,$bg = 1;$i<=95;$i++)
 {
	...
	if($info[0]=='team1'||$info[0]=='team2'||$info[0]=='team3' || $info[0]=='team4' || $info[0]=='team5' || $info[0]=='team8' ||$info[0]=='team10' ||$info[0]=='team11' || $info[0]=='team12' || $info[0]=='team13' || $info[0]=='team14' || $info[0]=='team16' || $info[0]=='team17' || $info[0]=='team18'|| $info[0]=='team19' || $info[0]=='team20' || $info[0]=='team21'|| $info[0]=='team22'|| $info[0]=='team24' || $info[0]=='team25' || $info[0]=='team29' || $info[0]=='team30' || $info[0]=='team33' || $info[0]=='team34' || $info[0]=='team35' || $info[0]=='team36' || $info[0]=='team37' || $info[0]=='team38' || $info[0]=='team39' || $info[0]=='team42' || $info[0]=='team45' || $info[0]=='team46' || $info[0]=='team48' || $info[0]=='team49' || $info[0]=='team50' || $info[0]=='team51' || $info[0]=='team53' || $info[0]=='team54' || $info[0]=='team56' || $info[0]=='team58' || $info[0]=='team60' || $info[0]=='team61' || $info[0]=='team64' || $info[0]=='team65' || $info[0]=='team66' || $info[0]=='team68' || $info[0]=='team69' || $info[0]=='team70' || $info[0]=='team71' || $info[0]=='team72' || $info[0]=='team73' || $info[0]=='team74' || $info[0]=='team75' || $info[0]=='team76' || $info[0]=='team77' || $info[0]=='team78' || $info[0]=='team79' || $info[0]=='team81' || $info[0]=='team82' || $info[0]=='team83' || $info[0]=='team84' || $info[0]=='team85' || $info[0]=='team86' || $info[0]=='team87' || $info[0]=='team88' || $info[0]=='team89' || $info[0]=='team90' || $info[0]=='team91' || $info[0]=='team92' || $info[0]=='team94' || $info[0]=='team95')
	continue ;
	$bg++;
	$j = substr($info[0],4);
	if($info[0]=='team24')
