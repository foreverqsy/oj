...
<div style="height:140px;">
	<div class="register">
      ...
      <div style="height:60px; margin:auto; margin-top:25px; font-size:27px;"> CODE OUR FUTURE !
         </div>
        <div class="zhuce" style="height:25px;line-height:25px;"><a href="acm_2_registerpage.php">加入我们<font style="color:#FFF; font-size:15px;">&nbsp;&nbsp;注册</font></a>
        </div>
    </div>
	<div class="login">
        ...
        <tr>
        	<td colspan="2"><div class="denglu" style="height:25px;line-height:25px;"><a href="javascript:loginn(form)">登&nbsp;&nbsp;&nbsp;录</a></div><div class="forget"><a href="acm_2_forgetpage.php" class="aaa">忘记帐号</a></div></td>
        </tr>
     </table>
     </div>
     </div>
...
<table width="952px" border="0px" bordercolor="#999999" cellspacing="0" cellpadding="0">
  <tr>
    <td><center><a href="share/acm.pdf"><img src="logo/001.png" style="width:200px; height:200px;" border="0"/><br /><font style="text-decoration:none" color="#666666">第二届ACM校赛</font></a></center></td>
    <td><center><a href="JudgeOnline/contest.php?cid=1004"><img src="logo/002.jpg"  border="0" style="width:200px; height:200px;" /><br /><font style="text-decoration:none" color="#666666">比赛入口</font></a></center></td>
    <td><center><a href="share/sutoj_instruction.pdf"><img src="logo/002.jpg" style="width:200px; height:200px;"  border="0"/><br /><font style="text-decoration:none" color="#666666">OJ使用说明</font></a></center></td>
  </tr>
</table>
</center>
