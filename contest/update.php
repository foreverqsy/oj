...
<table width=\"90%\"  border=\"0\" style=\" font-size:20px; font-family:微软雅黑\" class=\"bordered\">
	...
	<tr align=\"center\">
        ...
        <td width=35%><input  name=\"password\" type=\"text\" class=\"field\" /></td>
        <td width=15%><span style=\"float:right text-align=center\">确认密码</span></td>
        <td width=35%><input  name=\"password_2\" type=\"text\" class=\"field\" /></td>
    </tr>
...
<table width=\"90%\"  border=\"0\" style=\" font-size:20px; font-family:微软雅黑\" class=\"bordered\">
	...
	<tr align=\"center\">
        ...
        <td width=35%><input  name=\"team_name\" type=\"text\" class=\"field\"  value=\"$info1[nick]\"/></td>
