...
function check(form)
{
	...
	if(document.form.team_number1.value!="")
	{
		...
		num1 = parseInt(num1);
		if(num1<12&&(document.form.freshman_contest.value==1))
		{
			alert("新生赛专为12级同学准备..各位学长学姐们请刷新此页面后选择'校赛'..");
			return false;	
		}
	...
	if(document.form.team_number2.value!="")
	{
		...
		num2 = parseInt(num2);
		if(num2<12&&(document.form.freshman_contest.value==1))
		{
			alert("新生赛专为12级同学准备..各位学长学姐们请刷新此页面后选择'校赛'..");
			return false;	
		}
	...
	if(document.form.team_number3.value!="")
	{
		...
		num3 = parseInt(num3);
		if(num3<12&&(document.form.freshman_contest.value==1))
		{
			alert("新生赛专为12级同学准备..各位学长学姐们请刷新此页面后选择'校赛'..");	
			return false;
		}
