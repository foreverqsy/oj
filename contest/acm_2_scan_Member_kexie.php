...
$sql = "insert into scan_member(team_id,team_school,team_major,team_grade,team_member_name,team_name,team_pending,freshman_contest) select team_id,student_school,student_major,student_grade,team_member_name,team_name,team_telephone,freshman_contest from acm_2_user,student_information where substring(team_member_number,1,6)= student_number order by team_id asc";
$result = mysql_query($sql);
