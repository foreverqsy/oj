...
$sql="SELECT 
	users.user_id,users.nick,solution.result,solution.num,solution.in_date 
		FROM 
			(select * from solution where solution.contest_id='1007' and num>=0) solution 
		left join users 
...
<table width="80%" border="1" cellspacing="0" cellpadding="0">
 ...
 for($i=1,$bg = 1;$i<=62;$i++)
 {
    ...
    <td width=\"8%\"  bgcolor=\"$bg8\"><a href=\"javascript:tips($i,'F')\">$info[8]</a></td>
    <td width=\"8%\"  bgcolor=\"$bg9\"><a href=\"javascript:tips($i,'G')\">$info[9]</a></td>
    <td width=\"8%\"  bgcolor=\"$bg10\"><a href=\"javascript:tips($i,'H')\">$info[10]</a></td>
  </tr>";
 }
 ?>
</table>
